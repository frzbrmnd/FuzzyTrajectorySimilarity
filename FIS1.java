...
public class FIS1 {
    ...
    public static FIS distance_slopeSpeed() {
        FIS fis = new FIS();
        ...
        //fuzzify fis1
        Value fis1_veryNotMatchX[] = { new Value(0), new Value(0.3) };
        Value fis1_veryNotMatchY[] = { new Value(1), new Value(0) };
        MembershipFunction fis1_veryNotMatch = new MembershipFunctionPieceWiseLinear(fis1_veryNotMatchX, fis1_veryNotMatchY);

        Value fis1_notMatchX[] = { new Value (0.1), new Value(0.3), new Value(0.5) };
        Value fis1_notMatchY[] = { new Value (0), new Value(1), new Value(0) };
        MembershipFunction fis1_notMatch = new MembershipFunctionPieceWiseLinear(fis1_notMatchX, fis1_notMatchY);

        Value fis1_partlyMatchX[] = { new Value(0.3), new Value (0.5), new Value(0.7) };
        Value fis1_partlyMatchY[] = { new Value(0), new Value(1), new Value (0) };
        MembershipFunction fis1_partlyMatch = new MembershipFunctionPieceWiseLinear(fis1_partlyMatchX, fis1_partlyMatchY);

        Value fis1_matchX[] = { new Value(0.5), new Value (0.7), new Value(0.9) };
        Value fis1_matchY[] = { new Value(0), new Value(1), new Value (0) };
        MembershipFunction fis1_match = new MembershipFunctionPieceWiseLinear(fis1_matchX, fis1_matchY);

        Value fis1_veryMatchX[] = { new Value(0.7), new Value (1) };
        Value fis1_veryMatchY[] = { new Value(0), new Value(1) };
        MembershipFunction fis1_veryMatch = new MembershipFunctionPieceWiseLinear(fis1_veryMatchX, fis1_veryMatchY);

        LinguisticTerm fis1_ltVeryNotMatch = new LinguisticTerm("fis1_veryNotMatch", fis1_veryNotMatch);
        LinguisticTerm fis1_ltNotMatch = new LinguisticTerm("fis1_notMatch", fis1_notMatch);
        LinguisticTerm fis1_ltPartlyMatch = new LinguisticTerm("fis1_partlyMatch", fis1_partlyMatch);
        LinguisticTerm fis1_ltMatch = new LinguisticTerm("fis1_match", fis1_match);
        LinguisticTerm fis1_ltVeryMatch = new LinguisticTerm("fis1_veryMatch", fis1_veryMatch);

        fis1.add(fis1_ltVeryNotMatch);
        fis1.add(fis1_ltNotMatch);
        fis1.add(fis1_ltPartlyMatch);
        fis1.add(fis1_ltMatch);
        fis1.add(fis1_ltVeryMatch);
        ...
        //fuzzify result
        Value veryNotMatchX[] = { new Value(0), new Value(0.3) };
        Value veryNotMatchY[] = { new Value(1), new Value(0) };
        ...
        Value veryMatchX[] = { new Value(0.7), new Value (1) };
        Value veryMatchY[] = { new Value(0), new Value(1) };
    ...
    public static FIS diff_rating(){
        ...
        rule4.addConsequent(result, "veryMatch", false);
        ruleBlock.add(rule4);
    ...
    public static FIS time_difficulityrating(){
        ...
        rule17.addAntecedent(fis1, "fis1_notMatch", false);
        ...
        rule18.addAntecedent(fis1, "fis1_notMatch", false);
        ...
        rule19.addAntecedent(fis1, "fis1_notMatch", false);
        ...
        rule20.addAntecedent(fis1, "fis1_notMatch", false);
        ...
        rule21.addAntecedent(fis1, "fis1_veryNotMatch", false);
        ...
        rule22.addAntecedent(fis1, "fis1_veryNotMatch", false);
        ...
        rule23.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule23.addAntecedent(time, "medium", false);
        rule23.addConsequent(result, "veryNotMatch", false);
        ruleBlock.add(rule23);

        Rule rule24 = new Rule("Rule24", ruleBlock);
        rule24.addAntecedent(fis1, "fis1_veryNotMatch", false);
        ...
        rule25.addAntecedent(fis1, "fis1_veryNotMatch", false);
    ...
    public static FIS tdr_distance(){
        ...
        Variable fis1 = new Variable("fis1");
        Variable fis2 = new Variable("fis2");
        Variable result = new Variable("result");
        ...
        //fuzzify fis2
        Value fis2_veryNotMatchX[] = { new Value(0), new Value(0.3) };
        Value fis2_veryNotMatchY[] = { new Value(1), new Value(0) };
        MembershipFunction fis2_veryNotMatch = new MembershipFunctionPieceWiseLinear(fis2_veryNotMatchX, fis2_veryNotMatchY);

        Value fis2_notMatchX[] = { new Value (0.1), new Value(0.3), new Value(0.5) };
        Value fis2_notMatchY[] = { new Value (0), new Value(1), new Value(0) };
        MembershipFunction fis2_notMatch = new MembershipFunctionPieceWiseLinear(fis2_notMatchX, fis2_notMatchY);

        Value fis2_partlyMatchX[] = { new Value(0.3), new Value (0.5), new Value(0.7) };
        Value fis2_partlyMatchY[] = { new Value(0), new Value(1), new Value (0) };
        MembershipFunction fis2_partlyMatch = new MembershipFunctionPieceWiseLinear(fis2_partlyMatchX, fis2_partlyMatchY);

        Value fis2_matchX[] = { new Value(0.5), new Value (0.7), new Value(0.9) };
        Value fis2_matchY[] = { new Value(0), new Value(1), new Value (0) };
        MembershipFunction fis2_match = new MembershipFunctionPieceWiseLinear(fis2_matchX, fis2_matchY);

        Value fis2_veryMatchX[] = { new Value(0.7), new Value (1) };
        Value fis2_veryMatchY[] = { new Value(0), new Value(1) };
        MembershipFunction fis2_veryMatch = new MembershipFunctionPieceWiseLinear(fis2_veryMatchX, fis2_veryMatchY);

        LinguisticTerm fis2_ltVeryNotMatch = new LinguisticTerm("fis2_veryNotMatch", fis2_veryNotMatch);
        LinguisticTerm fis2_ltNotMatch = new LinguisticTerm("fis2_notMatch", fis2_notMatch);
        LinguisticTerm fis2_ltPartlyMatch = new LinguisticTerm("fis2_partlyMatch", fis2_partlyMatch);
        LinguisticTerm fis2_ltMatch = new LinguisticTerm("fis2_match", fis2_match);
        LinguisticTerm fis2_ltVeryMatch = new LinguisticTerm("fis2_veryMatch", fis2_veryMatch);

        fis2.add(fis2_ltVeryNotMatch);
        fis2.add(fis2_ltNotMatch);
        fis2.add(fis2_ltPartlyMatch);
        fis2.add(fis2_ltMatch);
        fis2.add(fis2_ltVeryMatch);
        ...
        Rule rule1 = new Rule("Rule1", ruleBlock);
        rule1.addAntecedent(fis1, "fis1_veryMatch", false);
        rule1.addAntecedent(fis2, "fis2_veryMatch", false);
        rule1.addConsequent(result, "veryMatch", false);
        ruleBlock.add(rule1);

        Rule rule2 = new Rule("Rule2", ruleBlock);
        rule2.addAntecedent(fis1, "fis1_veryMatch", false);
        rule2.addAntecedent(fis2, "fis2_match", false);
        rule2.addConsequent(result, "match", false);
        ruleBlock.add(rule2);

        Rule rule3 = new Rule("Rule3", ruleBlock);
        rule3.addAntecedent(fis1, "fis1_veryMatch", false);
        rule3.addAntecedent(fis2, "fis2_partlyMatch", false);
        rule3.addConsequent(result, "match", false);
        ruleBlock.add(rule3);

        Rule rule4 = new Rule("Rule4", ruleBlock);
        rule4.addAntecedent(fis1, "fis1_veryMatch", false);
        rule4.addAntecedent(fis2, "fis2_notMatch", false);
        rule4.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule4);

        Rule rule5 = new Rule("Rule5", ruleBlock);
        rule5.addAntecedent(fis1, "fis1_veryMatch", false);
        rule5.addAntecedent(fis2, "fis2_veryNotMatch", false);
        rule5.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule5);

        Rule rule6 = new Rule("Rule6", ruleBlock);
        rule6.addAntecedent(fis1, "fis1_match", false);
        rule6.addAntecedent(fis2, "fis2_veryMatch", false);
        rule6.addConsequent(result, "veryMatch", false);
        ruleBlock.add(rule6);

        Rule rule7 = new Rule("Rule7", ruleBlock);
        rule7.addAntecedent(fis1, "fis1_match", false);
        rule7.addAntecedent(fis2, "fis2_match", false);
        rule7.addConsequent(result, "match", false);
        ruleBlock.add(rule7);

        Rule rule8 = new Rule("Rule8", ruleBlock);
        rule8.addAntecedent(fis1, "fis1_match", false);
        rule8.addAntecedent(fis2, "fis2_partlyMatch", false);
        rule8.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule8);

        Rule rule9 = new Rule("Rule9", ruleBlock);
        rule9.addAntecedent(fis1, "fis1_match", false);
        rule9.addAntecedent(fis2, "fis2_notMatch", false);
        rule9.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule9);

        Rule rule10 = new Rule("Rule10", ruleBlock);
        rule10.addAntecedent(fis1, "fis1_match", false);
        rule10.addAntecedent(fis2, "fis2_veryNotMatch", false);
        rule10.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule10);

        Rule rule11 = new Rule("Rule11", ruleBlock);
        rule11.addAntecedent(fis1, "fis1_partlyMatch", false);
        rule11.addAntecedent(fis2, "fis2_veryMatch", false);
        rule11.addConsequent(result, "match", false);
        ruleBlock.add(rule11);

        Rule rule12 = new Rule("Rule12", ruleBlock);
        rule12.addAntecedent(fis1, "fis1_partlyMatch", false);
        rule12.addAntecedent(fis2, "fis2_match", false);
        rule12.addConsequent(result, "match", false);
        ruleBlock.add(rule12);

        Rule rule13 = new Rule("Rule13", ruleBlock);
        rule13.addAntecedent(fis1, "fis1_partlyMatch", false);
        rule13.addAntecedent(fis2, "fis2_partlyMatch", false);
        rule13.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule13);

        Rule rule14 = new Rule("Rule14", ruleBlock);
        rule14.addAntecedent(fis1, "fis1_partlyMatch", false);
        rule14.addAntecedent(fis2, "fis2_notMatch", false);
        rule14.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule14);

        Rule rule15 = new Rule("Rule15", ruleBlock);
        rule15.addAntecedent(fis1, "fis1_partlyMatch", false);
        rule15.addAntecedent(fis2, "fis2_veryNotMatch", false);
        rule15.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule15);

        Rule rule16 = new Rule("Rule16", ruleBlock);
        rule16.addAntecedent(fis1, "fis1_notMatch", false);
        rule16.addAntecedent(fis2, "fis2_veryMatch", false);
        rule16.addConsequent(result, "match", false);
        ruleBlock.add(rule16);

        Rule rule17 = new Rule("Rule17", ruleBlock);
        rule17.addAntecedent(fis1, "fis1_notMatch", false);
        rule17.addAntecedent(fis2, "fis2_match", false);
        rule17.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule17);

        Rule rule18 = new Rule("Rule18", ruleBlock);
        rule18.addAntecedent(fis1, "fis1_notMatch", false);
        rule18.addAntecedent(fis2, "fis2_partlyMatch", false);
        rule18.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule18);

        Rule rule19 = new Rule("Rule19", ruleBlock);
        rule19.addAntecedent(fis1, "fis1_notMatch", false);
        rule19.addAntecedent(fis2, "fis2_notMatch", false);
        rule19.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule19);

        Rule rule20 = new Rule("Rule20", ruleBlock);
        rule20.addAntecedent(fis1, "fis1_notMatch", false);
        rule20.addAntecedent(fis2, "fis2_veryNotMatch", false);
        rule20.addConsequent(result, "veryNotMatch", false);
        ruleBlock.add(rule20);

        Rule rule21 = new Rule("Rule21", ruleBlock);
        rule21.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule21.addAntecedent(fis2, "fis2_veryMatch", false);
        rule21.addConsequent(result, "match", false);
        ruleBlock.add(rule21);

        Rule rule22 = new Rule("Rule22", ruleBlock);
        rule22.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule22.addAntecedent(fis2, "fis2_match", false);
        rule22.addConsequent(result, "partlyMatch", false);
        ruleBlock.add(rule22);

        Rule rule23 = new Rule("Rule23", ruleBlock);
        rule23.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule23.addAntecedent(fis2, "fis2_partlyMatch", false);
        rule23.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule23);

        Rule rule24 = new Rule("Rule24", ruleBlock);
        rule24.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule24.addAntecedent(fis2, "fis2_notMatch", false);
        rule24.addConsequent(result, "notMatch", false);
        ruleBlock.add(rule24);

        Rule rule25 = new Rule("Rule25", ruleBlock);
        rule25.addAntecedent(fis1, "fis1_veryNotMatch", false);
        rule25.addAntecedent(fis2, "fis2_veryNotMatch", false);
        rule25.addConsequent(result, "veryNotMatch", false);
        ruleBlock.add(rule25);
    ...
    public static FIS distance_sstdr(){
    ...
    static void animateFis(FIS fis, double slope, double speed) throws Exception {
        if (JFuzzyChart.UseMockClass) {
            Gpr.debug("Using mock class");
            return; // Nothing done
        }
        JDialogFis jdf = new JDialogFis(fis, 800, 600);
        fis.getVariable("slope").setValue(slope);
    ...
    static void animateFis_dist_speed_slope(FIS fis, double distance, double fis1) throws Exception {
        if (JFuzzyChart.UseMockClass) {
            Gpr.debug("Using mock class");
            return; // Nothing done
        }
        ...
        fis.getVariable("fis1").setValue(fis1);
        fis.evaluate();
        // Create a plot
        System.out.println(fis.getVariable("result").getValue());
        jdf.repaint();
    ...
    public static void main(String[] args) throws Exception {
        ...
        FIS test = distance_sstdr();
        test.getVariable("fis1").setValue(1);
        test.getVariable("fis2").setValue(1);
        test.evaluate();
        System.out.println(test.getVariable("result").getValue());
        animateFis(test);
    }
}